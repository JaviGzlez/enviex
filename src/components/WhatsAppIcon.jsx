...
/**
 * Icono oficial de WhatsApp (glifo), tomado del WhatsApp Brand Resource Center.
 * Usa currentColor para poder pintarlo en verde de marca o en blanco según el fondo:
 * <WhatsAppIcon className="text-[#25D366]" /> o <WhatsAppIcon className="text-white" />
 */
